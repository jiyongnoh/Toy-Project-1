...
const avatarMap = {
  soyes: {
    name: '소예',
    codeName: 'soyes',
    iconImgUrl: '/src/Intro_IMG/Intro_Soyes_Icon_IMG.png',
    backgroundImgUrl: '/src/Background_IMG/Web/Intro_SoyesBackgroung_IMG.png',
  },
  lala: {
    name: '엘라',
    codeName: 'lala',
    iconImgUrl: '/src/Intro_IMG/Intro_Ella_Icon_IMG.png',
    backgroundImgUrl: '/src/Background_IMG/Web/Intro_EllaBackgroung_IMG.png',
  },
  pupu: {
    name: '푸푸',
    codeName: 'pupu',
    iconImgUrl: '/src/Intro_IMG/Intro_Pupu_Icon_IMG.png',
    backgroundImgUrl: '/src/Background_IMG/Web/Intro_SoyesBackgroung_IMG.png',
  },
  ubi: {
    name: '우비',
    codeName: 'ubi',
    iconImgUrl: '/src/Intro_IMG/Intro_Ubi_Icon_IMG.png',
    backgroundImgUrl: '/src/Background_IMG/Web/Intro_SoyesBackgroung_IMG.png',
  },
  north: {
    name: '북극이',
